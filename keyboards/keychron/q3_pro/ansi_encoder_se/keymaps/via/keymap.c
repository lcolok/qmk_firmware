...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [LAYER_6]   = { ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
    [LAYER_7] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [LAYER_8]   = { ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
};
