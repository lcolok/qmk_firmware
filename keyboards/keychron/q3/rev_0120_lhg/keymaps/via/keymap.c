...
[PLUS_THREE] = LAYOUT_ansi_87(KC_MS_BTN2,KC_MS_BTN3,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NLCK,KC_P7,KC_P8,KC_P9,KC_BSPC,TO(0),TO(2),TO(4),KC_NO,KC_NO,KC_NO,KC_NO,KC_PAST,KC_NO,KC_NO,KC_PMNS,KC_PPLS,KC_TRNS,KC_P4,KC_P5,KC_P6,KC_NO,KC_PGUP,KC_UP,KC_PGDN,KC_HOME,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_P1,KC_P2,KC_P3,KC_NO,KC_LEFT,KC_DOWN,KC_RGHT,KC_END,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_ENT,KC_TRNS,C(S(KC_Z)),C(S(KC_X)),C(S(KC_C)),KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_PSLS,KC_NO,KC_NO,KC_TRNS,KC_TRNS,KC_TRNS,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_P0,KC_PDOT,KC_PENT),
